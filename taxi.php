    ...
    <div class="row content">
        ...
        <div class="col-sm-9 content1-right" style="min-height: 100%;">
            ...
            <div class="busdeparture">
                ...
                echo '<table class="taxitable">
                    <tr><td rowspan="6" class="tabimg"><img class="img-fluid" src="images/taxi/' . $row["Logo_Image"] . '" class="imgfilm" alt="Taxiimage"/></td>
                        <td class="naziv"><h3>' . $row["Taxi_Name"] . '</h3></td></tr>
                    <tr><td class="zanr">' . $row["Taxi_Description"] . ' </td></tr>
